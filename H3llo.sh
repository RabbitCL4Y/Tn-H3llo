...
toilet -f future -F gay "  WELCOME TO MY TOOLS" |lolcat
toilet -f standard -F gay " Tools Installer Tn.H3LLO" |
lolcat


echo -e
"_____________________________________________________________"
echo -e "Tools Installer Tn.H3LLO :Have Fun R0NGS0K4N :J0K3R D4RK CL4N $white
" |lolcat
echo -e "Create by :Tn.H3LLO $white  " |lolcat
echo -e
"_____________________________________________________________"
...
6) echo "created by : Tn.H3LLO" | lolcat
exit
;;
